...
<body>
<header>
  <nav x-data="{ isOpen: false }" class="relative bg-black shadow dark:bg-gray-800 z-1000">
    <div class="container px-6 py-4 mx-auto lg:flex lg:justify-between lg:items-center">
        <div class="flex items-center justify-between">
            <a href="index.php" class="flex">
                <p class="font-semibold text-2xl text-white sm: text-xl">MENORCA RUGBY ADMIN</p>
            ...
            <div class="flex lg:hidden">
                <a  class = "text-left mt-3 mr-3"><i class="fa-regular fa-circle-user fa-xl hover: color-blue-200" style="color: #ffffff;" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation"></i></a><br><br>
        ...
        <div x-cloak :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-blue-900 dark:bg-gray-800 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:bg-transparent lg:w-auto lg:opacity-100 lg:translate-x-0 lg:flex lg:items-center">
            ...
            if($var_nombre !== " "){
                ...
                echo'
                <a class = "text-white  mx-3 hidden md:block">Bienvenido '.$var_nombre.'!</a>
                <a  class = "text-left m-0 p-0"><i class="fa-regular fa-circle-user fa-xl hover: color-blue-200 hidden md:block" style="color: #ffffff;" type="button" data-drawer-target="drawer-navigation" data-drawer-show="drawer-navigation" aria-controls="drawer-navigation"></i></a><br><br>';
...
<?php  
if($tipo == "admin"){
    include $_SERVER['DOCUMENT_ROOT'].'/proyecto_rugby/templates/sidebar_admin.php';

}else{
    include $_SERVER['DOCUMENT_ROOT'].'/proyecto_rugby/templates/sidebar.php';
}
